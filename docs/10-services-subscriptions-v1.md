...
Phase 4 delivered the general relation traversal/impact query services as part of
the Unified Library Core contract (`docs/11-unified-library-core.md`, Phase 4B).
Graph visualization and other desktop presentation remain Phase 5.
